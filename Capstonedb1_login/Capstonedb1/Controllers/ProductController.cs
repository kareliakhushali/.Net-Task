...
namespace Capstonedb1.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(ICategory categoryRepository, IWebHostEnvironment hostingEnvironment, IProduct productRepository, ISubCategory subCategoryRepository)
        {
